...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 随机生成img src
      getRandomImg () {
        let mySrc = this.pathTemplate + this.getRandomNumberByRange(this.imageNum[0], this.imageNum[1]) + '.' + this.imageType
        return this.isPrivate ? mySrc : 'https://picsum.photos/300/150/?image=' + this.getRandomNumberByRange(0, 1084)
      },
